  ...
  var icons = {
    ...
    <div>
      ...
      <Map center={position} zoom={this.state.zoom} maxZoom={20}>
        ...
        <div className="">
            <a href="/Hello"><img src = {process.env.PUBLIC_URL + '/Elements/Fullscreen.svg' } alt="Alertnotify" className="FullScreenButton" /><span className="tooltiptext">Full-Screen</span></a>
        </div>
        <MarkerClusterGroup
